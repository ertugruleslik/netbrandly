    ...
    'domains' => [
        ...
        'endpoints' => [
            ...
            [
                ...
                'description' => e('A domain can be added using this endpoint. You need to send the pixel type and the tag.'),
                'parameters' => [                    
        ...
        'endpoints' => [
            ...
            [
                ...
                'parameters' => [
                    ...
                    'type' => '(optional) Redirection type [direct, frame, splash], only <i>id</i> for custom splash page or <i>overlay-id</i> for cta pages',
