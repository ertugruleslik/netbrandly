            ...
            \Helpers\Emails::setup()
                    ...
                    ->send([
                        ...
                        'message' => function($template, $data) use ($report){
                            ...
                            return Email::parse($template, ['content' => 'A user reported a link as '.$report->type.'. Please review the link below and ban it as soon as possible:<br>'.$report->url, 'brand' => $title]);
                       }
                    ]);
