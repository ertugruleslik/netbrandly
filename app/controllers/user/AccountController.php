...
class Account {     
    ...
    public function twoFA(string $action, string $nonce){
        ...
        if($action == 'enable'){
            ...
            return Helper::redirect()->to(route('settings', ['qr' => 'true']))->with('success', e('2FA has been activated on your account. Please make sure to backup the secret key or the QR code.'));
        }
