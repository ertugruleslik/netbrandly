            ...
            <div class="card" id="qrbuilder">
                ...
                <div class="collapse" id="sms">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="text" class="form-label"><?php ee('Message') ?></label>
                            <input type="text" class="form-control p-2" name="sms[message]" placeholder="e.g. <?php ee('Job Application') ?>"></input>
                        </div>
                    </div>
                </div> 
                <div class="collapse" id="smsonly">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <label for="text" class="form-label"><?php ee('Phone Number') ?></label>
                            <input type="text" class="form-control p-2" name="smsonly[phone]" placeholder="e.g 123456789"></input>
                        </div>
                    </div>
                </div> 
                <div class="collapse" id="whatsapp">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <label for="text" class="form-label"><?php ee('Phone Number') ?></label>
                            <input type="text" class="form-control p-2" name="whatsapp[phone]" placeholder="e.g +123456789"></input>
                        </div>
                        <div class="form-group">
                            <label for="text" class="form-label"><?php ee('Message') ?></label>
                ...
                <div class="collapse" id="crypto">
                    <div class="card-header">
                        <h5 class="card-title fw-bold"><i class="me-2" data-feather="smartphone"></i> <?php ee('Crypto') ?></h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <p><?php ee('Cryptocurrency') ?></p>
                            <label class="me-3">
                                <input type="radio" name="crypto[currency]" value="btc"> <?php ee('Bitcoin') ?>
                            </label>
                            <label class="me-3">
