        ...
        <form method="post" action="<?php echo route('admin.plans.save') ?>" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control" name="icon" id="icon" value="<?php echo old('icon') ?>" placeholder="Icon class">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" data-binary="true" id="permission-qr-enabled" name="permission[bio][enabled]" value="1" data-toggle="togglefield" data-toggle-for="permission-bio-count">
