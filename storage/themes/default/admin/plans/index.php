<div class="d-flex">
    ...
    <div class="ms-auto">
        ...
        <?php if (\Helpers\App::isExtended()): ?>
            <a href="<?php echo route("admin.plans.sync") ?>" class="btn btn-primary"><i data-feather="repeat"></i>  <?php ee('Sync Plans') ?></a> 
            <a href="<?php echo route("admin.settings.config",['payments']) ?>" class="btn btn-primary"><i data-feather="settings"></i> <?php ee('Settings') ?></a> 
        <?php endif ?>
    </div>
</div>
