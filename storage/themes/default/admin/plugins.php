<div class="d-flex">
    ...
    <div class="ms-auto">
        ...
        <a href="#" data-bs-toggle="modal" data-trigger="modalopen" data-bs-target="#infoModal" class="btn btn-dark"><i data-feather="help-circle"></i></a>
    </div>
</div>
<div class="row">
    <div class="col-md-4">
      <form action="<?php echo route('admin.plugins.dir') ?>" method="get" class="card card-body">
        <div class="d-flex">
          ...
          <div class="ms-auto">
            <a href="<?php echo route('admin.plugins.dir') ?>" class="btn btn-primary btn-sm"><?php ee('Directory') ?></a>
          </div>
        </div>
        <div class="d-flex mt-3">
          <div class="input-group input-group-navbar">
              <input type="text" class="form-control" name="q" placeholder="Search for plugins" aria-label="Search">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><?php ee('Learn how to create a plugin') ?></h5>
