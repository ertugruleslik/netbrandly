            ...
            <div class="card-body">             
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="newcode" placeholder="Envato Purchase Code" value="<?php echo config("purchasecode") ?>">
                    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><span class="preloader me-2"><span class="spinner-border spinner-border-sm" role="status"></span></span> <?php ee('Updating...') ?> </h5>
      </div>
